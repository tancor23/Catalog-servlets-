...
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>LOST IN <span> FLeague </span>? Hmm, looks like that page doesn't exist.</h3>
    ...
    <a href="${pageContext.request.contextPath}/start"><button class="denied__link">Go Home</button></a>
</div>
</body>
</html>